...
VP_Security::instance()->whitelist_function('vp_vz_select10');
function vp_vz_select10($value)
{
...
VP_Security::instance()->whitelist_function('vp_vz_select9');
function vp_vz_select9($value)
{
...
VP_Security::instance()->whitelist_function('vp_vz_select8');
function vp_vz_select8($value)
{
	if(($value == 3) || ($value == 4) || ($value == 5) || ($value == 6) || ($value == 7) || ($value == 8) || ($value == 9) || ($value == 10))
		return true;
	return false;
}

VP_Security::instance()->whitelist_function('vp_vz_select7');
function vp_vz_select7($value)
{
...
VP_Security::instance()->whitelist_function('vp_vz_select6');
function vp_vz_select6($value)
{
	if(($value == 5) || ($value == 6) || ($value == 7) || ($value == 8) || ($value == 9) || ($value == 10))
		return true;
	return false;
}

VP_Security::instance()->whitelist_function('vp_vz_select5');
function vp_vz_select5($value)
{
...
VP_Security::instance()->whitelist_function('vp_vz_select4');
function vp_vz_select4($value)
{
...
VP_Security::instance()->whitelist_function('vp_vz_select3');
function vp_vz_select3($value)
{
...
VP_Security::instance()->whitelist_function('vp_vz_select2');
function vp_vz_select2($value)
{
	if(($value == 9) || ($value == 10))
		return true;
	return false;
...
VP_Security::instance()->whitelist_function('vp_vz_select1');
function vp_vz_select1($value)
{
	if(($value == 10))
		return true;
	return false;
...
VP_Security::instance()->whitelist_function('vp_select1');
function vp_select1($value)
{
    if(($value == 1))
        return true;
    return false;
...
VP_Security::instance()->whitelist_function('vp_select2');
function vp_select2($value)
{
    if(($value == 2))
        return true;
    return false;
